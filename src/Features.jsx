    ...
    return (
        <section className='bg-black pb-52'>
            <div className='container mx-auto px-3 md:px-10'>
                ...
                <BentoTilt className="border-hsla relative mb-7 h-96 w-full overflowh-hidden rounded-md max-h-[65vh]">
                    <BentoCard
                ...
                <div className="grid h-[135vh] grid-cols-2 grid-rows-3 gap-7">
                    <BentoTilt className="bento-tilt_1 row-span-1 md:col-span-1 md:row-span-2">
                        <BentoCard
                            ...
                            title={<>zig<b>m</b>a</>}
                            description="An anime and gaming-inspired NFT collection - the IP prime for expansion."
                        />
                    </BentoTilt>
                    ...
                    <BentoTilt className="bento-tilt_1 me-14 md:col-span-1 md:ms-0">
                        <BentoCard
